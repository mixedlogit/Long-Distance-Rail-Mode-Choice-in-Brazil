...
apollo_deltaMethod(model = model_rum,deltaMethod_settings = list(operation="ratio",parName1='b_fr',parName2="b_co", multPar1=60))
apollo_deltaMethod(model = model_rum,deltaMethod_settings = list(operation="ratio",parName1='b_fr',parName2="b_coair", multPar1=60))
