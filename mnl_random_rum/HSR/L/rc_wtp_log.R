...
apollo_control = list(
  modelName    = 'rc_rum 1',
  modelDescr   = "MNL RUM with random parameters",
  indivID      = "ID",
  mixing       = TRUE,
  nCores       = 6
)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['car']]  = asc_car + b_cocar*(b_tt*TT_CAR + CO_CAR) + b_age2*AGE_2 + b_age3*AGE_3 +
  ...
  V[['air']] = asc_air +  b_coair*(b_tt*TT_AIR + FA_AIR + b_fr*FR_AIR) + b_age2_air*AGE_2 + b_age3*AGE_3 +
    b_inc2*INC_2 + b_inc3*INC_3
...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rc_rum/HSR/L/lognormal/")
