...
apollo_control = list(
  modelName    = 'rc_rum 5',
  modelDescr   = "MMNL with random parameters",
  indivID      = "ID",
  mixing       = TRUE,
  nCores       = 6
)
...
apollo_draws = list(
  ...
  interNDraws    = 250,
  interUnifDraws = c("draws_tt","draws_fr")
)
...
apollo_randCoeff <- function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["b_tt"]] = mu_btt + sigma_btt*(2*draws_tt-1) 
  randcoeff[["b_fr"]] = mu_bfr + sigma_bfr*(2*draws_fr-1) 
...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rc_rum/HSR/L/uniforme/")
