...
apollo_randCoeff <- function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["b_tt"]] = exp(mu_btt + sigma_btt*draws_tt)/(1+exp(mu_btt + sigma_btt*draws_tt))
  randcoeff[["b_fr"]] = exp(mu_bfr + sigma_bfr*draws_fr)/(1+exp(mu_bfr + sigma_bfr*draws_fr))
...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rc_rum/HSR/W/Johnson/")
...
#VTTS RUM
apollo_deltaMethod(model = model,deltaMethod_settings = list(operation="logistic",parName1='mu_btt',parName2="sigma_btt"))
