...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rc_rum/HSR/W/wtpsp_const_triang/")
...
wtp_tt <- model$estimate[["bound_btt"]] + model$estimate[["bound_btt"]]*(runif(N) + runif(N))/2

plot(density(wtp_tt*60))
mean(wtp_tt)*60
sd(wtp_tt)
