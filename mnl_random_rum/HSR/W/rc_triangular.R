...
apollo_randCoeff <- function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["b_tt"]] = bound_btt + range_btt*(draws_tta + draws_ttb)/2 
 
  randcoeff[["b_fr"]] = bound_bfr + range_bfr*(draws_fra + draws_frb)/2 
...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rc_rum/HSR/W/triangular/")
