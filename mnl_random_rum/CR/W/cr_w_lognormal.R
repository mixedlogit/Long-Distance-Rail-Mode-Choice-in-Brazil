...
apollo_control = list(
  ...
  mixing       = TRUE,
  nCores       = 7,
  outputDirectory = "C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\6_Mixed model - SP Rail\\Model\\First Paper/mnl_rc_rum/CR/W/lognormal/"
)
...
b_co = model$estimate[['b_co']]
b_cocr = model$estimate[['b_cocr']]
b_coair = model$estimate[['b_coair']]
wtp = b_tt/b_co*60
wtp_cr = b_tt/b_cocr*60
wtp_air = b_tt/b_coair*60

apollo_deltaMethod(model = model,deltaMethod_settings = list(operation="ratio",parName1='b_fr',parName2="b_co"))
apollo_deltaMethod(model = model,deltaMethod_settings = list(operation="ratio",parName1='b_fr',parName2="b_cocr"))
apollo_deltaMethod(model = model,deltaMethod_settings = list(operation="ratio",parName1='b_fr',parName2="b_coair"))
