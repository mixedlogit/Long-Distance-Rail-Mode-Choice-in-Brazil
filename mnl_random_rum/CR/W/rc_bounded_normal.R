...
# ################################################################# #
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\SP Rail\\Rail Choice Data_Doutorado Cassiano\\First Paper")
...
apollo_control = list(
  modelName    = 'rc_rum 1',
  modelDescr   = "MNL RUM model for choice mode data, 250 mlhs draws and in WTP, positive lognormal TT/FR and negative logsnormal to CO",
  indivID      = "ID",
  mixing       = TRUE,
  nCores       = 5
)
...
apollo_draws = list(
  ...
  interNDraws    = 250,
  interUnifDraws = c("draws_tt",'draws_fr','draws_cocb','draws_coch','draws_coair')
)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['car']]  = asc_car + (b_tt*TT_CAR + b_cocb*CO_CAR) 
  
  V[['bus']]  = asc_bus +  (b_tt*TT_BUS + b_cocb*FA_BUS + b_fr*FR_BUS) 
  
  V[['cr']] = asc_cr + (b_tt*TT_CR + b_coch*FA_CR + b_fr*FR_CR)
  
  V[['hsr']] = asc_hsr + (b_tt*TT_HSR + b_coch*FA_HSR + b_fr*FR_HSR)
  
  V[['air']] = asc_air + (b_tt*TT_AIR +  b_coair*FA_AIR + b_fr*FR_AIR) 
...
#### MODEL ESTIMATION                                            ####
# ################################################################# #
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\SP Rail\\Rail Choice Data_Doutorado Cassiano\\First Paper\\rc_rum\\W")
