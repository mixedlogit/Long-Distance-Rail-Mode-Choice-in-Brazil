...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['car']]  = asc_car + b_tt*TT_CAR
  
  V[['bus']]  = asc_bus + (b_tt*TT_BUS) 
  
  V[['cr']] = asc_cr + (b_tt*TT_CR)
  
  V[['hsr']] = asc_hsr + (b_tt*TT_HSR)
  
  V[['air']] = asc_air + (b_tt*TT_AIR) 
...
#### MODEL ESTIMATION                                            ####
# ################################################################# #
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\Mixed model - SP Rail\\Model\\First Paper\\rc_rum\\W\\johnson")
