...
apollo_control = list(
  ...
  mixing       = TRUE,
  nCores       = 7,
  outputDirectory = "C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\6_Mixed model - SP Rail\\Model\\First Paper/mnl_rc_rum/CR/L/lognormal/"
)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['car']]  = asc_car + (b_tt*TT_CAR + b_cocar*CO_CAR) + b_age2*AGE_2 + b_age3*AGE_3 + b_inc2*INC_2 +
    b_inc3*INC_3
...
b_cocar = model$estimate[['b_cocar']]
b_coair = model$estimate[['b_coair']]
wtp = b_tt/b_co*60
wtp_car = b_tt/b_cocar*60
